...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |n|
    ...
    n.item :logout, safe_join([fa_icon('sign-out fw'), t('auth.logout')]), destroy_user_session_url(protocol: ((Rails.env.production? || ENV['LOCAL_HTTPS'] == 'true') && !ENV['LOCAL_DOMAIN'].ends_with?('.onion')) ? 'https' : 'http'), link_html: { 'data-method' => 'delete' }
  end
end
